...
(function ($, Drupal, debounce) {
  ...
  Drupal.behaviors.tmgmtAdminSourceSearchForm = {
    attach: function (context, settings) {
      var $checkUncheckAll = $(once('multi-checker', '.tmgmt-source-checkout-wrapper #edit-check-target-languages a', context));

      $checkUncheckAll.on('click', function() {
        var $targetLanguagesCheckboxesWrapper = $('.tmgmt-source-checkout-wrapper #edit-target-languages');
