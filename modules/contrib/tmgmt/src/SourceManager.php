...
class SourceManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/tmgmt/Source', $namespaces, $module_handler, 'Drupal\tmgmt\SourcePluginInterface', SourcePlugin::class, 'Drupal\tmgmt\Annotation\SourcePlugin');
