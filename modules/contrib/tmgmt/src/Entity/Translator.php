...
use Drupal\tmgmt\Entity\Controller\TranslatorAccessControlHandler;
...
#[ConfigEntityType(
  ...
  handlers: [
    'form' => [
      'edit' => TranslatorForm::class,
      'add' => TranslatorForm::class,
      'delete' => EntityDeleteForm::class,
      'clone' => TranslatorForm::class,
    ],
    'list_builder' => TranslatorListBuilder::class,
    'access' => TranslatorAccessControlHandler::class,
  ],
  links: [
    'collection' => '/admin/tmgmt/translators',
    'edit-form' => '/admin/tmgmt/translator/manage/[tmgmt_translator]',
