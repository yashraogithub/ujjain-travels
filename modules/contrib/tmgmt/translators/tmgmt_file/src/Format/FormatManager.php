...
use Drupal\tmgmt_file\Attribute\FormatPlugin;
...
class FormatManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/tmgmt_file/Format', $namespaces, $module_handler, '\Drupal\tmgmt_file\Format\FormatInterface', FormatPlugin::class, 'Drupal\tmgmt_file\Annotation\FormatPlugin');
